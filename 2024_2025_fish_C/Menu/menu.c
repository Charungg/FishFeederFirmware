...
void runningStartMenu(char* title){
    ...
    feedingScheduleData* feedingScheduleData = setFeederScheduleData();
...
void displayStartMenu(textData* startMenuTexts,feedingScheduleData* feedingScheduleData){
...
void runningMainMenu(feedingScheduleData* feedingScheduleData){
...
int runMainMenuOption(feedingScheduleData* feedingScheduleData, int currentOption){
